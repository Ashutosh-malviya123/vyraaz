...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Vyraaz FireTech – Fire Safety Services in Indore" },
      ...
      { name: "twitter:title", content: "Vyraaz FireTech – Fire Safety Services in Indore" },
      { name: "twitter:description", content: "Fire extinguisher refilling, alarms, hydrant systems & AMC in Indore." },
