...
const homeLabels: Record<LanguageCode, {
  ...
  en: {
    nav: ["Home", "About", "Services", "Products", "Projects", "Contact"],
  ...
  hi: {
    nav: ["होम", "हमारे बारे में", "सेवाएं", "उत्पाद", "प्रोजेक्ट्स", "संपर्क"],
  ...
  mr: {
    nav: ["मुख्यपृष्ठ", "आमच्याबद्दल", "सेवा", "उत्पादने", "प्रकल्प", "संपर्क"],
  ...
  ta: {
    nav: ["முகப்பு", "எங்களை பற்றி", "சேவைகள்", "தயாரிப்புகள்", "திட்டங்கள்", "தொடர்பு"],
  ...
  kn: {
    nav: ["ಮುಖಪುಟ", "ನಮ್ಮ ಬಗ್ಗೆ", "ಸೇವೆಗಳು", "ಉತ್ಪನ್ನಗಳು", "ಪ್ರಾಜೆಕ್ಟ್‌ಗಳು", "ಸಂಪರ್ಕ"],
  ...
  te: {
    nav: ["హోమ్", "మా గురించి", "సేవలు", "ఉత్పత్తులు", "ప్రాజెక్టులు", "సంప్రదించండి"],
  ...
  gu: {
    nav: ["હોમ", "અમારા વિશે", "સેવાઓ", "ઉત્પાદનો", "પ્રોજેક્ટ્સ", "સંપર્ક"],
  ...
  bn: {
    nav: ["হোম", "আমাদের সম্পর্কে", "সেবা", "পণ্য", "প্রজেক্ট", "যোগাযোগ"],
